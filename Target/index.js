...
function init() {
    ...
    // Sphere Geometry 1
    sphereGeometry1 = new THREE.SphereBufferGeometry(150, 30, 30);
    ...
    hemiLight = new THREE.HemisphereLight(0xffffff, 0xffff89, 1);
    ...
    // Fog
    scene.fog = new THREE.Fog(0x23265a, 0.5, 1700, 4000);
